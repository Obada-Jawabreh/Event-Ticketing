...
export default function HomeComponent() {
  ...
  return (
    <div className="min-h-screen max-w-7xl ml-24 mr-24 mb-12 overflow-y-auto flex justify-center items-center content-center flex-col mt-10">
