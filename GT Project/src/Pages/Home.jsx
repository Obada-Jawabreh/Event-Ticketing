...
export default function HomeComponent() {
  ...
  return (
    <div className="min-h-screen h-full ml-20 mr-20 mb-12   mt-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
        {events && events.slice(3, 6).map((event) => (
          <TicketCard
            key={event.id}
            name={event.name}
            startDate={event.startDate}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
        {events && events.slice(6, 9).map((event) => (
          <TicketCard
            key={event.id}
            name={event.name}
            startDate={event.startDate}
      ...
      <div className='flex justify-center mt-20 m-auto mb-3 border-blk'>
        <Accordion className='ms-70 mt-4 self-center text-white bg-second-dark' style={{width: '1350px'}}>
          ...
          <Accordion.Panel className='border-black focus:ring-transparent bg-blk'>
            <Accordion.Title className='text-white bg-blk text-sm hover:bg-blk focus:ring-transparent'>How do I purchase tickets for a gaming event on GTickets?</Accordion.Title>
            <Accordion.Content>
              <p className="mb-2 text-white text-sm">
              Visit our website at GTickets.com.
              Browse or search for the gaming event you want to attend.
          ...
          <Accordion.Panel className='border-black focus:ring-transparent'>
            ...
            <Accordion.Content>
              <p className="mb-2 text-white text-sm">
              Refunds and exchanges are subject to the event organizer's policy. Typically, tickets are non-refundable and non-exchangeable unless the event is canceled or rescheduled. Please check the specific event's refund policy on the event details page or contact our customer support for further assistance.Flowbite is first conceptualized and designed using the Figma software so everything you see in the library
          ...
          <Accordion.Panel className='border-black focus:ring-transparent'>
            <Accordion.Title className='text-white bg-blk text-sm hover:bg-light focus:ring-transparent'>How will I receive my tickets after purchase?</Accordion.Title>
            <Accordion.Content>
              <p className="mb-2 text-white text-sm">
              After you complete your purchase on GTickets, you will receive an email confirmation with your e-tickets attached. You can either print the tickets or display them on your mobile device at the event entrance. Make sure to bring a valid ID matching the name on the ticket for verification.
              </p>
            
            </Accordion.Content>
          </Accordion.Panel>
          <Accordion.Panel className='border-black focus:ring-transparent'>
            <Accordion.Title className='text-white text-sm bg-blk hover:bg-light focus:ring-transparent'>What should I do if I haven’t received my e-tickets?</Accordion.Title>
            <Accordion.Content>
              <p className="mb-2 text-white text-sm">
              If you haven’t received your e-tickets, please check your spam or junk email folder. If they are not there, contact our customer support team with your order number and email address used for the purchase. We will promptly resend your tickets to ensure you receive them in time for the event.
              </p>
    ...
    <div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
        ...
        <p className="max-w-2xl text-center dark:text-gray-600">Skilled developers crafting seamless ticketing experiences for gaming enthusiasts.</p>
        <div className="flex flex-row flex-wrap justify-center overflow-auto">
            <div className="flex flex-col justify-center m-4 text-center">
                <img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src={hero4} />
                <p className="text-xl font-semibold leading-tight">Obada Jawabreh</p>
            ...
            <div className="flex flex-col justify-center m-4 text-center">
                <img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src={hero4} />
                <p className="text-xl font-semibold leading-tight">Abd-alrahman Mnasour</p>
            ...
            <div className="flex flex-col justify-center m-4 text-center">
                <img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src={hero4} />
                <p className="text-xl font-semibold leading-tight">Mariam Khasawneh</p>
                <p className="dark:text-gray-600">Developer</p>
            </div>
            <div className="flex flex-col justify-center m-4 text-center">
                <img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src={hero4} />
