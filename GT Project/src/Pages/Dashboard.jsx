...
function Db() {
  ...
  function add_coupon() {
    axios
      .put(
        "https://project-4-bbf17-default-rtdb.europe-west1.firebasedatabase.app/coupons/" +
  ...
  function update_handle(id, e) {
    ...
    axios
      .put(
        `https://project-4-bbf17-default-rtdb.europe-west1.firebasedatabase.app/Events/${id}.json`,
        {
  ...
  return (
    <div className=" relative ">
      ...
      <aside
        id="nav"
        className="fixed top-0 left-0 flex-col w-64 h-full bg-[#0F041C] p-4 "
      >
        <div className="flex items-center pb-4 border-b border-b-gray-200 h-[10%]">
          ...
          <span className="text-lg font-bold text-gray-200 ml-3">
            <span className="text-[#9cdbff] text-xl">
              G<span className="text-[#ffffff]">Tickets</span>
            </span>
          </span>
        </div>
        ...
        <ul className="mt-4 mb-1 group active h-[80%]">
          ...
          <li
            className="flex items-center py-2 px-4 text-gray-200 mb-2  hover:bg-[#0d0b2a] hover:text-[#bee7ff] rounded-[10px]  "
            onClick={home_handle}
          >
        ...
        <div className="flex justify-center items-center pb-4 border-b border-b-gray-200 h-[10%]">
          <button className="border-[#bee7ff] text-[#0F041C] bg-[#ffffff] px-4 py-2 rounded-[10px] hover:bg-[#bee7ff] hover:text-[#ffffff]">
            Log out
          </button>
        </div>
      </aside>
        ...
        <nav className="py-2 px-6 bg-[#ffffff] flex items-center justify-between shadow-md shadow-black/5">
          ...
          <div className="flex justify-center items-center">
            ...
            <img
              src={uicon}
              alt=""
              className="h-11 w-11 ml-2  rounded-[100%] object-cover"
            />
          </div>
        </nav>
        ...
        <div className="p-6 ">
          <div className="home" id="home">
            ...
            <div className="bg-[#0F041C] p-3 rounded">
              <div className="flex justify-center">
                <span className="text-2xl w-full text-center pb-2 font-semibold text-white">
                  Events
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 h-[500px] overflow-scroll overflow-x-hidden mt-5">
                {Object.values(data).map((tracker) => {
                  return (
                    <div
                      key={tracker}
                      className="flex justify-between items-center h-[120px] text-[#1C1128]  bg-white "
                    >
                      ...
                      <p className="flex-col justify-start items-center m-3">
                        <span>{tracker.name.slice(0, 10)}</span>
                        <br />
                        <span>$ {tracker.price}</span>
                        <br />
                        <span>{tracker.location.slice(0, 10)}</span>
                        <br />
                        <span>
                          {tracker.startDate.slice(0, 10)} -{" "}
                          {tracker.endDate.slice(0, 10)}
                        </span>
                        <br />
                      </p>
              ...
              <div className=" w-[90%]  bg-[#0F041C] text-white rounded border-2 border-[#000000] px-6 py-4">
                ...
                {Object.values(users).map((tracker, index) => {
                  return (
                    <div
                      key={tracker}
                      className=" flex justify-between items-center my-3 p-2 rounded-[10px] border-0 border-[#000000]  shadow-lg shadow-[#bee7ff]"
                    >
          ...
          <div className="events hidden" id="events">
              ...
              <div className="bg-[#0F041C] p-3 rounded">
                <div className="flex justify-between items-center pb-2">
                  <div className="w-[25%] flex justify-start items-center">
                    <button
                      onClick={update_form_handle}
                      className="border-[#ffffff] text-[#0F041C] bg-[#ffffff] px-4 py-1 rounded-[10px] hover:bg-[#bee7ff] hover:text-[#ffffff]"
                    >
                      Update
                    </button>
                  </div>
                  ...
                  <div className="w-[25%] flex justify-end items-center">
                    <button
                      onClick={add_form_handle}
                      className="border-[#bee7ff] text-[#0F041C] bg-[#ffffff] px-4 py-1 rounded-[10px] hover:bg-[#bee7ff] hover:text-[#ffffff]"
                    >
                      Add
                    </button>
                  </div>
                ...
                <div className="flex flex-wrap h-[300px] overflow-scroll overflow-x-hidden">
                  {Object.values(data).map((tracker) => {
                    return (
                      <div
                        key={tracker}
                        className="flex  justify-between  items-center p-2 w-[49%] mx-auto my-2 bg-[#ffffff] rounded-[15px]"
                      >
                        <i className="fa-solid fa-ticket text-3xl w-[10%] hover:text-[#bee7ff]"></i>

                        <p className="text-sm text-start w-[75%] ml-2">
                          <span>{tracker.id}</span> -{" "}
                          <span>{tracker.name.slice(0, 10)}</span> -{" "}
                          <span>{tracker.location.slice(0, 9)}</span> -{" "}
                          <span>${tracker.price}</span>
                          <span className="ml-2">
                            {" "}
                            {tracker.startDate.slice(0, 10)}
                          </span>{" "}
                          to <span>{tracker.endDate.slice(0, 10)}</span>
                        </p>

                        <div className="icons w-[10%] flex justify-end items-center">
                          <i
                            className="fa-solid fa-trash text-xl hover:text-[#cd3e3e]  "
                            onClick={() => delete_handle(tracker.id)}
                          ></i>
            ...
            <div className="mt-12">
              <div className="bg-[#0F041C] p-3 rounded">
                <div className="flex justify-between items-center  pb-2">
                  <div className="w-[25%] flex justify-start items-center"></div>
                  ...
                  <div className="flex flex-wrap justify-center items-center">
                    {Object.values(coupons).map((tracker) => {
                      return (
                        <div
                          key={tracker}
                          className="flex  justify-between flex-wrap  items-center p-2 w-[20%] h-fit m-2 bg-[#ffffff] rounded-[15px]"
                        >
                          <i className="fa-solid fa-tags text-3xl w-[20%] hover:text-[#bee7ff]"></i>

                          <p className="text-sm text-center w-[60%]">
                            <span>{tracker.id}</span> -{" "}
                            <span>%{tracker.discount}</span>
                          </p>
                          ...
                          <div className="icons w-[20%]">
                            <i
                              className="fa-solid fa-trash text-xl hover:text-[#cd3e3e] "
                              onClick={() => {
                                coupon_delete_handle(tracker.id);
                              }}
                            ></i>
                          </div>
                        </div>
          ...
          <div
            className="add_form w-[100%] h-[100vh] absolute   bottom-0 left-0   hidden"
            id="add_form"
          >
            <div className="bg-[#0F041C] p-3 rounded ">
              <div className="add_event  flex-col justify-between items-start  w-[50%] h-[60%] p-5 text-[#000000] bg-[#bee7ff]   text-center  rounded mx-auto ">
                <h3 className="text-center text-2xl font-bold border-b-2 border-[#000000] pb-2">
                  Add Event
                </h3>
                  ...
                  <div className="up w-2/4 h-fit  text-left flex-col self-center">
                    <label htmlFor="" className="">
                      ...
                      <input
                        id="e_name"
                        type="text"
                        className=" w-5/6 h-10 my-2 px-2 text-[#000000] bg-[#ffffff] rounded-[10px] border-2 border-[#ffffff]  "
                      />
                    </label>
                    ...
                    <label htmlFor="" className="">
                      ...
                      <input
                        id="e_start_date"
                        type="text"
                        className=" w-5/6 h-10 my-2 text-[#000000] px-2 bg-[#ffffff] rounded-[10px] border-2 border-[#ffffff]  "
                      />
                    </label>
                  </div>
                ...
                <div className="text-left">
                  <label htmlFor="" className="">
                    ...
                    <input
                      id="e_image"
                      type="text"
                      className=" w-full h-10 my-2 px-2 text-[#000000] bg-[#ffffff] rounded-[10px] border-2 border-[#ffffff] "
                    />
                  </label>
                </div>
                ...
                <div className="h-2/6 ">
                  <button
                    className="px-5 py-2 bg-[#ffffff] text-[#1C1128] rounded m-5"
                    onClick={add_handle}
                  >
                    Add Event
                  </button>
          ...
          <div
            className="update_form w-[100%] h-[100vh] absolute   bottom-0 left-0   hidden"
            id="update_form"
          >
                  ...
                  <div className="up w-2/4 h-fit  text-left flex-col self-center">
                    <label htmlFor="" className="">
                      ...
                      <input
                        id="e_name_u"
                        type="text"
                        className="w-5/6 h-10 my-2 px-2 bg-[#ffffff] rounded-[10px] border-2 border-[#ffffff]  "
                      />
                    </label>
                ...
                <div className="flex-col h-[600px] overflow-scroll overflow-x-hidden">
                  {Object.values(data).map((tracker) => {
                    return (
                      <div
                        onClick={() => {
                          select_event_handle(tracker.id);
                        }}
                        key={tracker}
                        className="flex  justify-between  items-center p-2 w-[200px] mx-auto my-2 bg-[#ffffff] rounded-[15px]"
                      >
                        <i className="fa-solid fa-ticket text-3xl w-[10%] hover:text-[#bee7ff]"></i>
          ...
          <div
            className="coupon_add_form w-[100%] h-[100vh] absolute   bottom-0 left-0   hidden"
            id="coupon_add_form"
          >
            <div className="bg-[#0F041C] p-3 rounded flex justify-center items-center ">
              <div className="add_coupon  flex-col justify-between items-start  w-[40%] h-full bg-[#bee7ff]   text-center py-3 px-10 rounded mx-auto ">
                <div className="flex-row flex-wrap justify-center items-center h-1/2">
                  <h3 className="text-2xl font-bold border-b-2 border-[#000000] pb-2">
                    Add Coupon
                  </h3>
                  ...
                  <div className="inputs flex justify-center items-center w-full text-left ">
                    <label htmlFor="" className="">
                      ...
                      <input
                        id="coupon_id"
                        type="text"
                        className="text- h-10 my-2 px-2 bg-[#ffffff] rounded-[10px] border-2 border-[#ffffff] text-[#000000] mx-3 "
                      />
                    </label>
                  ...
                  <div key={tracker} className="w-[300px] h-[100px]    m-6">
                    ...
                    <div className="shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] p-2 bg-[#ffffff] border-2 border-[#000000] rounded">
                      <div className="  w-full flex justify-between items-center border-b-2 pb-2 border-[#000000]">
                        <div className="w-[75%] text-start font-semibold">
                          {tracker.userEmail}
                        </div>
                      </div>
